    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-white px-6 text-center">
        ...
        <p className="mt-3 max-w-md text-base text-muted-foreground">
          {licenseReason ||
            "El acceso a este sistema ha sido suspendido temporalmente debido a un pago pendiente del servicio de mantenimiento."}
        </p>
        <p className="mt-2 text-sm text-muted-foreground">
          Una vez confirmado el pago, el acceso será restablecido
          automáticamente.
        </p>
        <Button
          size="lg"
          ...
          onClick={() =>
            window.open(
              `mailto:contacto@europamodels.com?subject=Soporte%20Europa%20Models`,
            )
          }
        >
